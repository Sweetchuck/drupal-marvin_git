...
namespace Drupal\Tests\marvin_git\Unit;

use Drupal\marvin\Utils as MarvinUtils;
use Drupal\Tests\marvin_git\Helper\DummyOutput;
use Drupal\Tests\marvin_git\Helper\TaskBuilder;
...
class TaskTestBase extends TestCase {
   ...
   * @phpstan-param array<string, mixed> $actual
   */
